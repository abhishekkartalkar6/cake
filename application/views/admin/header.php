...
<html lang="en">
    <head>
        ...
        <title>My-giftsy</title>
        <link href="https://cdn.jsdelivr.net/npm/simple-datatables@7.1.2/dist/style.min.css" rel="stylesheet" />
        <link href="<?php echo base_url();?>/assets/admincss/styles.css" rel="stylesheet" />
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="<?php base_url('dashboard') ?>">My-giftsy</a>
            <!-- Sidebar Toggle-->
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="<?php echo base_url('add_cat'); ?>">Categories</a>
                                    <a class="nav-link" href="<?php echo base_url('banner'); ?>">Banner</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="orders" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="layout-static.html">All Orders</a>
                                </nav>
                            </div>
