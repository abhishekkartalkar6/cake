...
<html lang="en">
  ...
  <body class="goto-here">
    <nav class="navbar navbar-expand-lg " style="background-color:#f8eeec" id="ftco-navbar">
	    <div class="container">
            <img src="assets/images/store_logo.jpeg" width="80" alt="logo">
	      <a class="navbar-brand" href="index.html"><span style="color:black">myGiftsy</span></a>
	        ...
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	            ...
	            <div class="col-md-12 ftco-animate text-center">
	              <h1 class="mb-2">We serve Fresh Cakes &amp; Pestries</h1>
	              <h2 class="subheading mb-4">We deliver organic Cakes</h2>
